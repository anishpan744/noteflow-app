...
abstract class $SubTaskCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, bool isCompleted, int sortOrder});
}
...
class _$SubTaskImpl extends _SubTask {
  ...
  @override
  String toString() {
    return 'SubTask(id: $id, title: $title, isCompleted: $isCompleted, sortOrder: $sortOrder)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, isCompleted, sortOrder);
...
abstract class _SubTask extends SubTask {
  const factory _SubTask(
      ...
      final bool isCompleted,
      final int sortOrder}) = _$SubTaskImpl;
